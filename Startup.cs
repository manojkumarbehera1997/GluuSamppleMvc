...
namespace SampleMvcApp
{
    public class Startup
    {
        ...
        private string Introspect(string access_token)
        {
            ...
            var request = (HttpWebRequest)WebRequest.Create($"https://" + getOIDCConfig.OIDC.Domain + $"/" + getOIDCConfig.OIDC.CustomPath + "/restv1/introspection");
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            //            .MinimumLevel.Debug()
            //            .WriteTo.RollingFile(Path.Combine(env.ContentRootPath, "wwwroot/log/oidc-log-{Date}.log"))
            //            .CreateLogger();
            Log.Logger = new LoggerConfiguration()
